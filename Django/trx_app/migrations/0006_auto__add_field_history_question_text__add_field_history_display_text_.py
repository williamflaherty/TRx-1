...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'History.question_text'
        db.add_column(u'trx_app_history', 'question_text',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=300),
                      keep_default=False)

        # Adding field 'History.display_text'
        db.add_column(u'trx_app_history', 'display_text',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=100),
                      keep_default=False)

        # Adding field 'History.display_group'
        db.add_column(u'trx_app_history', 'display_group',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'History.question_text'
        db.delete_column(u'trx_app_history', 'question_text')

        # Deleting field 'History.display_text'
        db.delete_column(u'trx_app_history', 'display_text')

        # Deleting field 'History.display_group'
        db.delete_column(u'trx_app_history', 'display_group')
