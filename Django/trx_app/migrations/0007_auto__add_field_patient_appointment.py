...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.appointment'
        db.add_column(u'trx_app_patient', 'appointment',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.appointment'
        db.delete_column(u'trx_app_patient', 'appointment')
