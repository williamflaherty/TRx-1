...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Doctor.firstName'
        db.alter_column(u'trx_app_doctor', 'firstName', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding model 'SurgeryType_Config'
        db.create_table(u'trx_app_surgerytype_config', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('surgery_name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True)),
        ))
        ...
        db.create_table(u'trx_app_doctor_config', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('doctor_name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True)),
        ))
        db.send_create_signal(u'trx_app', ['Doctor_Config'])


        # Changing field 'Doctor.firstName'
        db.alter_column(u'trx_app_doctor', 'firstName', self.gf('django.db.models.fields.CharField')(default=' ', max_length=255))
