...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.display_group'
        db.alter_column(u'trx_app_question', 'display_group', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Question.question_type'
        db.alter_column(u'trx_app_question', 'question_type', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Question.display_group'
        db.alter_column(u'trx_app_question', 'display_group', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Question.question_type'
        db.alter_column(u'trx_app_question', 'question_type', self.gf('django.db.models.fields.CharField')(max_length=5))
